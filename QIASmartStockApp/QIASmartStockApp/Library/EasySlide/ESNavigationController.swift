...
class ESNavigationController: UINavigationController, UIGestureRecognizerDelegate {
	...
	private var leftRevealType: RevealType = .SlideAlong
	...
	private var rightRevealType: RevealType = .SlideAlong
...
//			vc.containerView.addSubview(viewController.view)
//			vc.navigationItem.title = viewController.title
//		}
//
